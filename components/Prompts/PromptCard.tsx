    ...
    >
        ...
        <div className="absolute bottom-2 left-2">
          <div className="w-max bg-black hover:bg-[#16252] duration-300 transition-opacity hover:text-black text-white p-[10px] items-center flex rounded-xl">
            <Image
              ...
              alt=""
            />
            <span className={`${styles.label} pl-2 text-white`}>@Bhavna</span>
          </div>
        </div>
      </div>
      ...
      <div className="w-full flex items-center justify-between">
        <div className="flex items-center">
          <Avatar src="https://pixner.net/aikeu/assets/images/author/author-1.png" />
          <span className={`${styles.label} pl-3`}>@Bhavna</span>
        </div>
        <Ratings rating={5} />
      </div>
      <br />
